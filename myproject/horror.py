...
class App():
    ...
    def game_screen(self):
        ...
        if self.step in self.scare_point:
            px.blt(35, 35, 0, 48, 0, 16, 16, 0)  # ビックリ２
        elif self.step % 2 == 0:
            if self.step >= 46 and self.step <= 51:
                px.blt(35, 35, 0, 48, 0, 16, 16, 0)  # ビックリ２
            else:
                px.blt(35, 35, 0, 0, 0, 16, 16, 0)
        else:
            if (self.step >= 46 and self.step <= 51) or self.step == 55:
                px.blt(35, 35, 0, 32, 0, 16, 16, 0)
            else:
                px.blt(35, 35, 0, 16, 0, 16, 16, 0)
    ...
    def skelton(self):  # ホラー演出３
        ...
        # bloody skelton
        px.blt(self.blood_x, 35, 0, 16, 16, 16, 16, 0)
        px.blt(self.blood_x+15, 35, 0, 16, 16, 16, 16, 0)
    ...
    def game_over(self):
        px.cls(8)
        px.text(px.width/3+3, 35, 'Game Over', 0)
